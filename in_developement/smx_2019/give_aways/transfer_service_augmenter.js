...
// This Google Ads Script creates tables and views in bigquery 
// and transfers data from Google Ads to Bigquery,
// which is not transfered by Transfer Service.


// Enable Bigquery in "Advanced API" > Bigquery before executing this script

// The dataset must exist in bigquery project.

var settings = {
	BIGQUERY_PROJECT_ID : "",
	BIGQUERY_DATASET_ID : "",
	SEND_ERROR_MESSAGES_TO : "your@email.tld",
	RECREATE_VIEWS : false, // usefull for developement. keep it set to false
	TABLE_NAME_PREFIX : "p_", // transfer service uses this prefix for tables. keep it set to 'p_' for consistency with transfer service
	
	CREATE_GEOTARGETS : true, // shall we do geo targets?
	GEOTARGETS_URL : "https://goo.gl/cZXkiJ", // where to get geo targets form
	GEOTARGETS_TABLE_NAME : "p_Geotargets", // name of geo targets table ( with p_ prefix )
	
	TIMEZONE : "Europe/Berlin", // timezone
	SCRIPT_NAME : "BigQuery_Augmenter", // name of the script used in emails
	TARGET_SETTING_CONSTANT : "USER_INTEREST_AND_LIST", // don't change it
};
