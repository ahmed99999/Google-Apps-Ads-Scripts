...
// App script for Search Query analysis with Cloud NL + linear regression in Bigquery

// In Google App Scripts enable following advanced Services in Resources > Advanced Google Services
// - Google Sheets API
// - BigQuery API

// Enable language API here: https://console.developers.google.com/apis/api/language.googleapis.com/overview?project=YOUR_PROJECT_ID

// Enable transfer service (for google ads) and wait for the first successfull run before executing this script.

// Execute "main" function in app scripts.


// Account id used for transfer service ( Can be either an MCC-account or not )
var TRANSFER_SERVICE_ACCOUNT_ID = 1234567890;

var TRANSFER_SERVICE_DATASET_ID = 'DATASET_IN_BIGQUERY_FOR_TRANSFER_SERVICE';
...
var DICTIONARY_SHEETS_URL = 'https://docs.google.com/spreadsheets/d/_ADD_ID_OF_YOUR_SHEET_HERE...';

// The names of columns in dictionary sheet.
var DICTIONARY_COLUMNS = [ 'Brand', 'Location', 'Property' ];

// Bigquery settings
var PROJECT_LOCATION = 'US'; // bigquery default location is US
var PROJECT_ID = ''; // Bigquery project id
var DATASET_ID = 'smx_2019'; // Bigquery dataset id
...
// Cloud NL API settings. Create a API key in google console https://console.developers.google.com/apis/credentials?project=YOUR_PROJECT_ID
var NL_API_KEY = 'a1a1a1a1a1a1a-a1a1a1a1a1a1a1a1a1-a1a1a1';
var LANGUAGE = 'de-de'; // Language-setting for Cloud NL API. also possible: 'en-us'
var SERVICE_TYPE = 'analyzeEntities'; // function of the NL API to use. don't change it
var FIELDS = [ 'metadata', 'name', 'type', 'salience' ]; // attributes of NL API to take. Don't change it.
...
function prepareData2(){
	...
	Logger.log( 'computed query: ' + computedQuery );
