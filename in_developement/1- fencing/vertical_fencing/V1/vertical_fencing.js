...
var ACCOUNTS = [
	'Peak Ace Script Account #3'
	// 'Schülerhilfe Deutschland',
	// 'Schülerhilfe DE Franchise',
	// 'Schülerhilfe Nachhilfelehrer Suche',
];
...
var SOURCE = {
	CAMPAIGN : {
		// NAMEX_CONTAINS_OPERAND : 'AND',
		NAME_CONTAINS: [ 'Brand', 'Product' ],
	...
	KEYWORD : {
		STATUS_IN : [ 'ENABLED' ],//, 'PAUSED'
	},
};

var TARGET = {
	CAMPAIGN : {
		NAME_CONTAINS : [ 'BBM', 'EXT' ],
		NAME_DOES_NOT_CONTAIN : [],
		STATUS_IN : [ 'ENABLED' ],
	},
};
...
function fromReport(){
	...
	return function( level, conditions, source ){
		var list = [];
...
function getCampaigns( settings, obtainer, source ){
	return getItems( obtainer, CAMPAIGN_LEVEL, settings, source );
}
