...
function setTheDataSheet( accounts, webproperties, views ){
...
function initialazeTemplate(){
    clearSheet( DIMENTIONS_SHEET_NAME, START_ROW );
    ...
    buildDropDownList( [ 7, 14, 30 ], DIMENTIONS_SHEET_NAME.getRange( START_ROW, 6, DIMENTIONS_SHEET_NAME.getMaxRows(), 1 ) );
    buildDropDownList( accounts, DIMENTIONS_SHEET_NAME.getRange('A3:A') );
    buildDropDownList( [], DIMENTIONS_SHEET_NAME.getRange('B3:B') );
    buildDropDownList( [], DIMENTIONS_SHEET_NAME.getRange('C3:C') );
}
...
function Main(){
    ...
    setTheDataSheet( accounts, webproperties, views);
    initialazeTemplate();
}
