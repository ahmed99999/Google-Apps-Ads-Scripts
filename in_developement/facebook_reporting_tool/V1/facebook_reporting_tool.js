...
var config = {
    ...
    "CLIENT_SECRET" : "",
    "FB_AD_ACCOUNT_ID" : "",
    "FB_FIELDS" : "clicks,spend,impressions,campaign_name,adset_name,ad_name",
    "FB_LEVEL" : "ad",
    "pos" : [{"2": 2},{"1":1}],  
    "DATE_RANGE":"",
...
// More FB_FIELDS at https://developers.facebook.com/docs/marketing-api/insights/fields/v2.3 
   ...
   //Spreadsheet Cell Position
    ...
    //today, yesterday, this_month, last_month, this_quarter, etc 
 ...
 * function.
 * @param {Object} callbackRequest The request data received from the callback
 *     function.
