...
var config = {
	...
	"VERSION_TAG" : "stable",
	"settings" : {
		"SCRIPT_NAME" : "Anomaly_Detector",
		"TIME_ZONE" : "Europe/Berlin",
		"LAG_DATA_SHEET_URL" : "https://docs.google.com/spreadsheets/d/1M6tIKpBV6l8boioI8EaQ6AI9HUQy9-H4z1-Dl6AoLkk/edit#gid=0",
		...
		"DOWN_SENSITIVITY" : {
			...
			"Conversions" : 4,
			"ConversionValue" : 4,
			"SearchImpressionShare" : 6,
			"SearchRankLostImpressionShare" : 6,
			"SearchBudgetLostImpressionShare" : 6,
			"Cpo" : 6,
			"Ctr" : 5,
			"Cpc" : 4,
			"Cvr" : 6
