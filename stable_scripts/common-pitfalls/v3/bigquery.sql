...
JOIN `biddy-io.peak_ace_active_clients_transfer.KeywordBasicStats_1036246249` AS stat ON stat.ExternalCustomerId = adgroup.ExternalCustomerId AND stat.CampaignId = adgroup.CampaignId AND stat.AdGroupId = adgroup.AdGroupId AND DATE_DIFF( CURRENT_DATE( 'Europe/Berlin' ), _DATA_DATE, DAY ) <= 30
WHERE TRUE
